...
public class MegaModifiers : MonoBehaviour
{
	...
	{
		MegaModifier mod = (MegaModifier)UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(gameObject, "Assets/Standard Assets/Scripts/MegaFiers/Modifiers/MegaModifiers.cs (614,36)", type);
