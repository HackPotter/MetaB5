...
public class ScreenSpaceSubsurfaceScattering : MonoBehaviour {
    ...
    void OnRenderImage(RenderTexture source,RenderTexture destination)
    {
        ...
        scam.renderingPath = this.GetComponent<Camera>().renderingPath;
        ...
        scam.nearClipPlane = this.GetComponent<Camera>().nearClipPlane;
        scam.farClipPlane = this.GetComponent<Camera>().farClipPlane;
        ...
        if (this.GetComponent<Camera>().actualRenderingPath != RenderingPath.DeferredLighting && QualitySettings.antiAliasing != 0)
        {
