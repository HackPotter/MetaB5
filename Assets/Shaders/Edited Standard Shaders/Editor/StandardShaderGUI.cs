...
namespace UnityEditor
{
    internal class StandardShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            // Scan Properties
            public static string scanText = "Scan Features";
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            //Scan Features
            GUILayout.Label(Styles.scanText, EditorStyles.boldLabel); // Working
            m_MaterialEditor.ShaderProperty(rimColor,Styles.rimColorText); // Working
